...
function Navbar() {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-white-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md  bg-red-400 dark:bg-slate-500 dark:text-red duration-300 transition-all ease-in-out": ""
  }`}
  >
   ...
   <label className="input input-bordered flex items-center gap-2 text-white border border-red-500">
